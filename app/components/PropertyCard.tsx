...
const PropertyCard = (props: Props) => {
  ...
  return (
    <Link href={props.link}>
      <div className="max-w-96 lg:w-fit dark-shadow dark:hover:shadow-gray-700 rounded-xl flex flex-col lg:flex-row  h-auto card-side  bg-base-100 shadow ease-in-out hover:shadow-xl duration-500">
        <Image
          className="aspect-[16/9] lg:aspect-[9/14] lg:w-48 object-cover rounded-l-lg lg:rounded-tr-none lg:rounded-br-none"
          src={props.image}
          alt="green marine"
        />{" "}
